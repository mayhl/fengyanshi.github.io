...
# -*- coding: utf-8 -*-
#
# funwave documentation build configuration file, created by
...
exclude_patterns = ['Thumbs.db', '.DS_Store', 'external/FUNTOOL/.venv']

#include_patterns = ['**', 'external/FUNTOOL/docs/src/*']
...
latex_documents = [
    (master_doc, 'funwave.tex', 'funwave Documentation',
     'Fengyan', 'manual'),
]
...
man_pages = [
    (master_doc, 'funwave', 'funwave Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'funwave', 'funwave Documentation',
     author, 'funwave', 'One line description of project.',
     'Miscellaneous'),
]
